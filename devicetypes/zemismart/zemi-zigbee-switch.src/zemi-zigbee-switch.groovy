...
metadata {
    definition(name: "Zemi ZigBee Switch", namespace: "zemismart", author: "Onaldo", ocfDeviceType: "oic.d.switch", vid: "generic-switch") {
        ...
        fingerprint endpointId: "01", profileId: "81A7", inClusters: "0000, 0003, 0004, 0005, 0006", manufacturer: "_TYZB01_Lrjzz1UV", model: "TS0013", deviceJoinName: "Lasco Zigbee Switch 1"
        fingerprint endpointId: "01", profileId: "81A7", inClusters: "0000, 0003, 0004, 0005, 0006", manufacturer: "TUYATEC-O6SNCwd6", model: "TS0012", deviceJoinName: "Lasco Zigbee Switch 1"
        fingerprint endpointId: "01", profileId: "81A7", inClusters: "0000, 0003, 0004, 0005, 0006", manufacturer: "TUYATEC-p9HCE8pZ", model: "TS0011", deviceJoinName: "Lasco Zigbee Switch 1"
   }
...
private getEndpointCount() {
    ...
    switch (model) {
        ...
        case 'TS0012' : return 2
        case 'TS0011' : return 1
        default : return 0
    }
}
